declare namespace React {
  namespace JSX {
    interface IntrinsicElements {
      ...
      "dap-ds-navigation-menu": import("dap-design-system/dist/react-types").DapDSNavigationMenuType
      "dap-ds-navigation-menu-item": import("dap-design-system/dist/react-types").DapDSNavigationMenuItemType
...
interface ShowDapSnackbarOptions {
...
declare function showDapSnackbar(message: string, options?: ShowDapSnackbarOptions): void
