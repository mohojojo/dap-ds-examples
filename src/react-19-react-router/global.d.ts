declare namespace React {
    namespace JSX {
      interface IntrinsicElements {
        'dap-ds-accordion': import('dap-design-system/dist/react-types').DapDSAvatarType
        'dap-ds-anchor-heading': import('dap-design-system/dist/react-types').DapDSAnchorHeadingType
        'dap-ds-avatar': import('dap-design-system/dist/react-types').DapDSAnchorHeadingType
